...
Behavioral ransomware detection & response for Linux — eBPF tracepoints, sliding-window verdicts, automated SIGKILL response.

[![Rust](https://img.shields.io/badge/Rust%20·%20eBPF-security%20agent-F15A24?style=flat-square&logo=rust)](.) [![PyPI](https://img.shields.io/pypi/v/talus-process-monitor?style=flat-square&logo=pypi&logoColor=white)](https://pypi.org/project/talus-process-monitor/)
